...
const StyledList = styled.ul`
  ...
  /* We must to pass the position y and x like props  */
...
function Toggle({ id }) {
  ...
  function handleOnClick(e) {
    ...
    // If current state are empty string or current state is !== from passed id set passed id to state
...
function List({ id, children }) {
  ...
  // Coppy element for can i use on top to DOM
  return createPortal(
